        ...
        <nav className="bg-white">
            ...
            <div className={`md:hidden w-full ${isOpen ? "block" : "hidden"}`}>
                        <div className="flex font-medium md:p-0 mt-1 mb-4 bg-gray-200 md:space-x-8 flex-col md:border-0 bg-white">
                            ...
                            <a href="#" className="block py-2 px-3 text-gray-900 hover:bg-gray-100"onClick={handleItemClick}>Blog</a>
                            <a href="#" className="block py-2 px-3 text-gray-900 hover:bg-gray-100"onClick={handleItemClick}>Tentang Kami</a>
